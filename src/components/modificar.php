...
<body>
	 <?php
       ...
       $conn = conectar();
       $datos = buscarProvedor($cod,$conn);
    ?>
    <form class="modedit" action="../call/agregar_proveedor.php" method="post">
        <h1>MODIFICAR A UN PROVEEDOR</h1>
        ...
        <input class="input" type="text" name="contacto" value="<?=$datos[2]?>"><br>
